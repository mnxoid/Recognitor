...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_CameraCapture_t, stringdata) + ofs \
...
QT_MOC_LITERAL(5, 35, 8)
    ...
    "CameraCapture\0updatePic\0\0cv::Mat\0m\0"
    "response\0"
};
...
void CameraCapture::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->updatePic((*reinterpret_cast< cv::Mat(*)>(_a[1]))); break;
        ...
        {
            typedef void (CameraCapture::*_t)(cv::Mat );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&CameraCapture::updatePic)) {
                *result = 0;
            }
        }
        {
            typedef void (CameraCapture::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&CameraCapture::response)) {
                *result = 1;
            }
        }
    }
...
const QMetaObject CameraCapture::staticMetaObject = {
    { &QThread::staticMetaObject, qt_meta_stringdata_CameraCapture.data,
      qt_meta_data_CameraCapture,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_CameraCapture.stringdata))
...
// SIGNAL 0
void CameraCapture::updatePic(cv::Mat _t1)
{
