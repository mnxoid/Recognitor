...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_AdminScreen_t, stringdata) + ofs \
...
QT_MOC_LITERAL(5, 83, 23)
    ...
    "AdminScreen\0on_pushButton_clicked\0\0"
...
const QMetaObject AdminScreen::staticMetaObject = {
    { &QMainWindow::staticMetaObject, qt_meta_stringdata_AdminScreen.data,
      qt_meta_data_AdminScreen,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_AdminScreen.stringdata))
